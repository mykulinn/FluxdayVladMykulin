...
namespace Fluxday.Automation.Tests.PageObject.OKRPage.AddNewOKR
{
    public class AddNewOKRPageObject : BaseObject.BasePageObject
    {
        ...
        protected IWebElement OKRLeftButton
        {
            get
            {
                return Driver.FindElement(By.XPath("//ul[@class = 'side-nav sidebar-links top-set']//a[@href = '/okrs']"));
            }
        }
        ...
        protected IWebElement NewOKRButton
        {
            get
            {
                return DriverFindElementWithWait(By.XPath("//a[text() = 'New OKR']"));
            }
        }
        ...
        protected IWebElement SaveButton
        {
            get
            {
                return DriverFindElementWithWait(By.CssSelector("#pane3 .right>input"));
            }
        }
        ...
        protected IWebElement NameInput
        {
            get
            {
                return DriverFindElementWithWait(By.Id("okr_name"));
            }
        }
        ...
        protected IWebElement StartDateInput
        {
            get
            {
                return DriverFindElementWithWait(By.Id("okr_start_date"));
            }
        }
        ...
        protected IWebElement EndDateInput
        {
            get
            {
                return DriverFindElementWithWait(By.Id("okr_end_date"));
            }
        }
        ...
        protected IWebElement AddNewObjectiveButton
        {
            get
            {
                return DriverFindElementWithWait(By.CssSelector("#objectives>.links>a"));
            }
        }
        ...
        public void OKRLeftButtonClick() => OKRLeftButton.Click();
        public void NewOKRButtonClick() => NewOKRButton.Click();
    }
}
